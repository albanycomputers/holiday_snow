...
Go to **Configuration > user Interface > Holiday Snow** (`/admin/config/user-interface/holiday-snow`).

## Issues:

Bugs and Feature requests should be reported in the Issue Queue: https://github.com/backdrop-contrib/holiday_snow/issues
